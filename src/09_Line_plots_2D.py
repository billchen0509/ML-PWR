...
# ---------- 5. Build participant-level tidy dataframe ----------
...
# Use raw p-values to match the requested p <= 0.05 criterion.
p_column_for_plot = "p_value"

# To plot only FDR-adjusted significant findings instead, use:
